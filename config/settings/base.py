...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://postgres:q2457326@localhost:5432/nomadgram'),
}
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware', #CommonMiddleware 앞에 위치해야함
